...
namespace LinqAndCsharp.Repository
{
    ...
    partial void OnReviewNumberChanging(string value);
    ...
    partial void OnReviewerChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="review", Storage="_Review", DbType="NVarChar(512) NOT NULL", CanBeNull=false)]
		public string ReviewNumber
		{
			...
			set
			{
				...
				{
					this.OnReviewNumberChanging(value);
					this.SendPropertyChanging();
					this._Review = value;
					this.SendPropertyChanged("ReviewNumber");
					this.OnReviewNumberChanged();
				}
			}
		}
